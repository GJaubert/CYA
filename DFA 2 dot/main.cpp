...
#include "DFAWriter.h"
  ...
  /** Comprobamos si los argumentos estan bien escritos*/
    ...
    if (str.compare(help) == 0 ) {
      ...
      /** Creamos objeto gestor*/
      gestor lectura(argv[1]);	
      /** Leemos fichero y gestionamos argumentos*/
      lectura.Read();
      /** Creamos objeto DFA*/
      DFA automata(lectura);
      /** Creamos objeto para escribir*/
      DFAWriter escritura(argv[2]);
      /** Realizamos la escritura*/
      escritura.MainWrite(automata);
      }
  }
